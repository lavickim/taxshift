-- National Pension 데이터 임포트
-- 임시 테이블 생성
CREATE TEMP TABLE temp_national_pension (
...
-- CSV 데이터 로드 (헤더 스킵)
\COPY temp_national_pension FROM '/tmp/national_pension_sample.csv' WITH CSV HEADER DELIMITER ',';

...
export default function SettingsScreen({ navigation }: any) {
  ...
  const updatePreferences = (key: string, value: boolean) => {
    // TODO: Implement preference updates with backend
  ...
  const getSettingIcon = (iconName: string) => {
    switch (iconName) {
      ...
      case 'shield-checkmark-outline': return '🔒';
      case 'notifications-outline': return '🔔';
      case 'pricetag-outline': return '🏷️';
      case 'analytics-outline': return '📊';
      case 'download-outline': return '📥';
      case 'cloud-upload-outline': return '☁️';
      case 'help-circle-outline': return '❓';
        ...
        <View style={styles.profileSection}>
          <View style={styles.profileInfo}>
            ...
            <View style={styles.userInfo}>
              ...
              <Text style={styles.userStatus}>무료 사용자</Text>
            </View>
          </View>
        ...
        {settingsSections.map((section, sectionIndex) => (
          <View key={sectionIndex} style={styles.section}>
            ...
            {section.items.map((item, itemIndex) => (
              ...
              >
                <Text style={styles.settingIcon}>{getSettingIcon(item.icon)}</Text>

...
-- 3. 키워드-태그 매핑 시딩
INSERT INTO keyword_tag_mappings (keyword_group_id, tag_id, confidence_score, priority, amount_range_min, amount_range_max, time_context_rules, is_active, usage_count, created_at) 
SELECT 
    kg.id, 
    tm.id, 
    CASE 
...
-- 4. 태그-계정 매핑 시딩
INSERT INTO tag_account_mappings (tag_id, account_code, account_name, amount_range_min, amount_range_max, is_default, priority, confidence_boost, created_at)
SELECT 
    tm.id,
    CASE 

...
ipcMain.handle('toggle-always-on-top', () => {
  ...
  const newAlwaysOnTop = !currentAlwaysOnTop
  
  mainWindow.setAlwaysOnTop(newAlwaysOnTop)
  store.set('alwaysOnTop', newAlwaysOnTop)
  
  // 렌더러에 상태 변경 알림
  mainWindow.webContents.send('always-on-top-changed', newAlwaysOnTop)
  
  return newAlwaysOnTop
})

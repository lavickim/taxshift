...
export function MonthEndClosingManagement() {
  ...
  const [closingResult, setClosingResult] = useState<ClosingResult | null>(
    null
  );
  ...
  const generateTrialBalance = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/v2/accounting/trial-balance?${params}`
      );
      const result = await response.json();
        ...
        <CardContent className='space-y-4'>
          <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
            ...
            <div className='space-y-2'>
              ...
              <Select
                value={fiscalMonth.toString()}
                onValueChange={value => setFiscalMonth(parseInt(value))}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
              ...
              <AlertDescription>
                <div className='space-y-2'>
                  ...
                  <div className='grid grid-cols-2 gap-4 text-sm'>
                    <div>
                      마감된 계정: {closingResult.closedAccountsCount}개
                    </div>
                    <div>
                      처리시간:{' '}
                      {formatProcessingTime(closingResult.processingTimeMs)}
                    </div>
                  </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='grid grid-cols-3 gap-4'>
                    ...
                    <Card className='p-4'>
                      ...
                      <div
                        className={`text-lg font-semibold ${trialBalance.isBalanced ? 'text-green-600' : 'text-red-600'}`}
                      >
            ...
            <CardContent className='space-y-4'>
              ...
              {incomeStatement && (
                <div className='space-y-4'>
                  {/* 수익 */}
                  <div>
                    <h3 className='mb-2 font-semibold'>수익</h3>
                    <Table>
                      <TableBody>
                        {Object.entries(incomeStatement.revenues).map(
                          ([account, amount]) => (
                  ...
                  {/* 비용 */}
                  <div>
                    <h3 className='mb-2 font-semibold'>비용</h3>
                    <Table>
                      <TableBody>
            ...
            <CardContent className='space-y-4'>
              ...
              {balanceSheet && (
                <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
                  {/* 자산 */}
                  <div>
                    <h3 className='mb-2 font-semibold'>자산</h3>
                    <Table>
                      <TableBody>
                  ...
                  <div className='space-y-4'>
                    {/* 부채 */}
                    <div>
                      <h3 className='mb-2 font-semibold'>부채</h3>
                      <Table>
                        <TableBody>
                    ...
                    {/* 자본 */}
                    <div>
                      <h3 className='mb-2 font-semibold'>자본</h3>
                      <Table>
                        <TableBody>
                ...
                <div className='space-y-6'>
                  ...
                  <Card className='bg-primary/5 p-4'>
                    <div className='flex items-center justify-between'>
                      ...
                      <span
                        className={`text-xl font-bold ${cashFlowStatement.netCashChange >= 0 ? 'text-green-600' : 'text-red-600'}`}
                      >
                ...
                <div className='space-y-4'>
                  ...
                  <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
                    <Card className='p-4'>
                      ...
                      <div className='text-lg font-semibold'>
                        {formatCurrency(validationResult.assets)}
                      </div>
                    </Card>
                    <Card className='p-4'>
                      <div className='text-sm text-muted-foreground'>
                      ...
                      <div className='text-lg font-semibold'>
                        {formatCurrency(validationResult.liabilitiesAndEquity)}
                      </div>
                    </Card>
                    <Card className='p-4'>
                      <div className='text-sm text-muted-foreground'>차이</div>
                      <div
                        className={`text-lg font-semibold ${validationResult.difference === 0 ? 'text-green-600' : 'text-red-600'}`}
                      >
      ...
      <Card>
        ...
        <CardContent>
          <div className='flex flex-wrap gap-2'>
            <Button
              onClick={generateComprehensiveFinancialStatements}
              disabled={isLoading}
            >
            ...
            <Button
              variant='outline'
              onClick={() => toast.info('마감 이력을 조회합니다.')}
            >
            ...
            <Button
              variant='outline'
              onClick={() => toast.info('마감 보고서를 생성합니다.')}
            >
              <FileText className='mr-2 h-4 w-4' />
              마감 보고서 생성
            </Button>
            <Button
              variant='outline'
              onClick={() => toast.info('보고서가 다운로드됩니다.')}
            >

              ...
              <CardContent>
                <div className='mb-4 grid grid-cols-2 gap-4 md:grid-cols-4'>
                  <div className='rounded-lg border p-4 text-center'>
                    <div
                      className={`text-2xl font-bold ${getComplexityColor(analysis.complexity)}`}
                    >
                  ...
                  <div className='rounded-lg border p-4 text-center'>
                    <div
                      className={`text-2xl font-bold ${getPerformanceColor(analysis.performanceImpact)}`}
                    >
                  ...
                  <div>
                    ...
                    <div className='space-y-2'>
                      {rule.testCases.slice(0, 3).map((testCase, idx) => (
                        ...
                        >
                          <div className='mb-1 font-mono text-gray-800'>
                            입력: {testCase.input}
                          </div>
                      ...
                      {rule.testCases.length > 3 && (
                        <div className='text-center text-sm text-gray-500'>
                          ... 및 {rule.testCases.length - 3}개 추가 테스트
                          케이스
                        </div>
                      )}
                    </div>

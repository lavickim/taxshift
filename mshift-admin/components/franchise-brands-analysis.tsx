    ...
    try {
      ...
      const [overviewRes, categoryRes, brandRes, detailRes] = await Promise.all(
        [
          ...
          fetch(
            `/api/data-analysis/franchise-brands?type=details&page=1&limit=50&search=${searchTerm}&industry=${selectedCategory}`
          ),
        ]
      );
            ...
            <div className='flex items-center'>
              ...
              <div className='ml-4'>
                ...
                <p className='text-2xl font-bold text-white'>
                  {formatNumber(overviewData.totalBrands)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='rounded-lg border border-gray-700 bg-gray-800 p-6 shadow-lg'>
            <div className='flex items-center'>
              ...
              <div className='ml-4'>
                ...
                <p className='text-2xl font-bold text-white'>
                  {formatNumber(overviewData.totalCompanies)}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='rounded-lg border border-gray-700 bg-gray-800 p-6 shadow-lg'>
            <div className='flex items-center'>
              ...
              <div className='ml-4'>
                ...
                <p className='text-2xl font-bold text-white'>
                  {formatNumber(overviewData.industryCount)}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className='flex items-center'>
              ...
              <div className='ml-4'>
                ...
                <p className='text-sm font-bold text-white'>
                  {overviewData.yearRange?.minYear || 'N/A'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='rounded-lg border border-gray-700 bg-gray-800 p-6 shadow-lg'>
            <div className='flex items-center'>
              ...
              <div className='ml-4'>
                ...
                <p className='text-sm font-bold text-white'>
                  {overviewData.yearRange?.maxYear || 'N/A'}
                </p>
              </div>
            </div>
          </div>

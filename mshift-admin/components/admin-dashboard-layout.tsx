...
export function AdminDashboardLayout() {
  ...
  return (
    <main className='flex min-h-screen flex-col bg-background'>
      {/* 상단 네비게이션 */}
      <nav className='h-16 w-full border-b border-b-foreground/10 bg-card'>
        <div className='flex h-full w-full items-center justify-between p-3 px-5 text-sm'>
      ...
      <div className='flex flex-1'>
        ...
        <aside className='w-64 border-r border-border bg-muted/30 p-4'>
          <nav className='space-y-2'>
            ...
            <Button
              variant={
                activeTab === 'regex-preprocessing' ? 'secondary' : 'ghost'
              }
              className='w-full justify-start'
            ...
            <Button
              variant={
                activeTab === 'accounting-engine' ? 'secondary' : 'ghost'
              }
              className='w-full justify-start'
            ...
            <Button
              variant={
                activeTab === 'test-and-rule-expansion' ? 'secondary' : 'ghost'
              }
              className='w-full justify-start'
        ...
        <main className='flex-1 p-6'>
          ...
          {activeTab === 'regex-preprocessing' && (
            <RegexPreprocessingManagement />
          )}

...
import { TestTube, Building, Zap, BarChart3 } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">거래문자열 테스트</CardTitle>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="transaction-test" className="flex items-center gap-2">
        ...
        <TabsContent value="transaction-test" className="space-y-6 mt-6">
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                거래 문자열을 입력하여 키워드 기반 분류 시스템을 실시간으로 테스트합니다.
                새로운 패턴을 발견하면 자동으로 룰 확장을 제안합니다.
              </p>
            </CardHeader>
            <CardContent>
              <KeywordRuleTest />
        ...
        <TabsContent value="brand-test" className="space-y-6 mt-6">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
      ...
      <Card className="bg-muted/50">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="pt-4 border-t">
            <h4 className="font-semibold mb-2">🚀 최근 개선 사항</h4>

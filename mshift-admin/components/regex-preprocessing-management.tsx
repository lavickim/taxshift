          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">우선순위 조정이 필요합니다.</p>
              </div>
              <Button variant="outline" size="sm">해결하기</Button>
            </div>
            <div className="flex items-start gap-3">
              <Clock className="h-4 w-4 text-blue-500 mt-0.5" />
              <div>
                <p className="font-medium">성능 저하: 처리 시간 5ms 초과 (12회)</p>
                <p className="text-sm text-muted-foreground">패턴 최적화를 권장합니다.</p>
              </div>
              <Button variant="outline" size="sm">최적화</Button>
            </div>
          </div>
        </CardContent>
      </Card>

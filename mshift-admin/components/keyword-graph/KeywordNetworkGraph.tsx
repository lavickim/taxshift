  ...
  useEffect(() => {
    ...
    nodes
      .on('click', (event, d) => {
        ...
        links
          .attr('stroke', link =>
            (link.source as GraphNode).id === d.id ||
            (link.target as GraphNode).id === d.id
              ? '#ff6b6b'
              : '#999'
          )
    ...
    svg.on('click', () => {
      ...
      links.attr('stroke', '#999').attr('stroke-opacity', 0.3);
    });
      ...
      {selectedNode && (
        <div className='mt-4 rounded-lg bg-gray-50 p-4'>
          ...
          <div className='mt-2 space-y-1 text-sm text-gray-600'>
            <p>
              <strong>카테고리:</strong> {selectedNode.category}
            </p>
            <p>
              <strong>빈도:</strong> {selectedNode.frequency}
            </p>
            <p>
              <strong>신뢰도:</strong>{' '}

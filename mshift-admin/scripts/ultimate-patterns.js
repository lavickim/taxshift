...
const ULTIMATE_PATTERNS = {
  ...
  '카드사완전확장': {
    keywords: [
      '기업은행카드', 'IBK기업은행카드', 'IBK CARD',
      '새마을금고카드', '새마을금고', 'MG새마을금고',
      '신협카드', '신용협동조합', '지역신협',
      '저축은행카드', '상호저축은행', '산업은행카드',
      '수협카드', '수협은행카드', '산림조합카드',
      '우체국카드', '우체국체크카드',
      '전북은행카드', '경남은행카드', '광주은행카드',
      '제주은행카드', '전남은행카드', '대구은행카드',
      '부산은행카드', 'BNK부산은행', 'DGB대구은행'
    ],
    tag: '금융',
    accountCode: '999',
    accountName: '금융수수료',
  ...
  '페이서비스': {
    keywords: [
      '애플페이', 'APPLE PAY', '구글페이', 'GOOGLE PAY',
      '엘페이', 'L.PAY', '카카오페이', 'KAKAO PAY',
      '제로페이', 'ZERO PAY', '네이버페이', 'NAVER PAY',
      '페이코', 'PAYCO', '시럽페이', 'SYRUP PAY',
      '스마일페이', 'SMILE PAY', '하나페이', '우리페이',
      '신한페이', '국민페이', 'KB페이', '머니트리',
      '간편결제', '간편송금', '페이', 'PAY'
    ],
    tag: '간편결제',
  ...
  '철도교통완전': {
    keywords: [
      '누리로', 'NURIRO', 'ITX청춘', 'ITX-청춘', 'ITX새마을', 'ITX-새마을',
      '수서고속철도', 'SRT수서', '경인선', '태백선', '영동선',
      '경전선', '전라선', '장항선', '경북선', '동해선',
      '충북선', '중앙선', '경의선', '경춘선', '경원선',
      '평택선', '장항선', '호남선', '전라선', '경전선',
      '동해선', '태백선', '영동선', '중앙선'
  ...
  '할인혜택': {
    keywords: [
      ...
      '경로할인', '노인할인', '시니어할인',
      '장애인할인', '중증환자할인',
      '유공자할인', '국가유공자할인', '보훈대상자할인',
      '다자녀할인', '임산부할인', '육아맘할인',
      '군인할인', '의경할인', '의무소방관할인',
      '할인', 'DISCOUNT', '혜택', '우대', '면제'
    ],
    tag: '교통할인',
    accountCode: '611',
    accountName: '여비교통비',
  ...
  '특수서비스': {
    keywords: [
      '배달의민족', '배민', 'BAEMIN', '요기요', 'YOGIYO',
      '쿠팡이츠', 'COUPANG EATS', '배달앱', '딜리버리',
      '우버이츠', 'UBER EATS', '배달음식', '배달주문',
      '카카오택시', '카카오T', '타다', 'TADA',
      '우버', 'UBER', '그랩', 'GRAB', '카풀',
      '온라인주문', '픽업주문', '포장주문', '테이크아웃',
      '배달', 'DELIVERY', '픽업', 'PICKUP'
    ],
    tag: '배달서비스',
    accountCode: '651',
    accountName: '접대비',
  ...
  '기타브랜드': {
    keywords: [
      // 추가 카페 브랜드
      '투썸', 'A TWOSOME', '커피빈앤티리프',
      '더카페', 'THE CAFE', '카페드롭탑', 'DROP TOP',
      
      // 추가 음식점
      '버거킹', 'BURGER KING', '롯데리아', 'LOTTERIA',
      '도미노', 'DOMINOS', '피자스쿨', 'PIZZA SCHOOL',
      
      // 기타 편의점
      '바이더웨이', 'BY THE WAY', '위드미', 'WITH ME',
      
      // 기타 서비스
      '펀치', 'PUNCH', '이마트몰', '이마트 온라인몰',
      '홈플러스몰', '롯데몰', 'LOTTE MALL'
    ],
    tag: '기타서비스',
    accountCode: '634',
    accountName: '소모품비',

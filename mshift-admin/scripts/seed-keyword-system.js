...
const INITIAL_DATA = {
  ...
  keywordTagMappings: [
    // 편의점 매핑
    { keywordGroupName: "세븐일레븐", tagName: "편의점", confidenceScore: 0.95, priority: 1 },
    { keywordGroupName: "CU편의점", tagName: "편의점", confidenceScore: 0.93, priority: 1 },
    { keywordGroupName: "이마트24", tagName: "편의점", confidenceScore: 0.92, priority: 1 },
    { keywordGroupName: "GS25", tagName: "편의점", confidenceScore: 0.90, priority: 1 },
    
    // 주유소 매핑
    { keywordGroupName: "GS칼텍스", tagName: "주유소", confidenceScore: 0.98, priority: 1 },
    { keywordGroupName: "SK에너지", tagName: "주유소", confidenceScore: 0.97, priority: 1 },
    { keywordGroupName: "현대오일뱅크", tagName: "주유소", confidenceScore: 0.95, priority: 1 },
    { keywordGroupName: "S-Oil", tagName: "주유소", confidenceScore: 0.94, priority: 1 },
    
    // 패스트푸드 매핑
    { keywordGroupName: "맥도날드", tagName: "패스트푸드", confidenceScore: 0.96, priority: 1 },
    { keywordGroupName: "롯데리아", tagName: "패스트푸드", confidenceScore: 0.93, priority: 1 },
    { keywordGroupName: "버거킹", tagName: "패스트푸드", confidenceScore: 0.92, priority: 1 },
    { keywordGroupName: "KFC", tagName: "패스트푸드", confidenceScore: 0.91, priority: 1 },
    
    // 카페 매핑
    { keywordGroupName: "스타벅스", tagName: "카페", confidenceScore: 0.98, priority: 1 },
    { keywordGroupName: "커피빈", tagName: "카페", confidenceScore: 0.90, priority: 1 },
    { keywordGroupName: "이디야", tagName: "카페", confidenceScore: 0.88, priority: 1 },
    { keywordGroupName: "투썸플레이스", tagName: "카페", confidenceScore: 0.89, priority: 1 },
    
    // 온라인 서비스 매핑
    { keywordGroupName: "쿠팡", tagName: "온라인쇼핑", confidenceScore: 0.95, priority: 1 },
    { keywordGroupName: "배달의민족", tagName: "배달앱", confidenceScore: 0.97, priority: 1 },
    { keywordGroupName: "요기요", tagName: "배달앱", confidenceScore: 0.93, priority: 1 },
    { keywordGroupName: "카카오택시", tagName: "교통", confidenceScore: 0.91, priority: 1 }
  ],
  ...
  testCases: [
    {
      name: "편의점 테스트",
      cases: [
        { input: "세븐일레븐 강남점에서 커피 구매", expectedTag: "편의점", expectedAccount: "602" },
        { input: "CU편의점 야식 구매 02:30", expectedTag: "편의점", expectedAccount: "655" },
        { input: "이마트24 생필품 구매", expectedTag: "편의점", expectedAccount: "602" },
        { input: "GS25 음료수 구매", expectedTag: "편의점", expectedAccount: "602" }
      ]
    },
    {
      name: "주유소 테스트", 
      cases: [
        { input: "GS칼텍스 주유소 휘발유 충전", expectedTag: "주유소", expectedAccount: "622" },
        { input: "SK에너지 셀프 주유", expectedTag: "주유소", expectedAccount: "622" },
        { input: "현대오일뱅크 경유 충전", expectedTag: "주유소", expectedAccount: "622" },
        { input: "S-Oil 주유소 연료비", expectedTag: "주유소", expectedAccount: "622" }
      ]
    },
    {
      name: "패스트푸드 테스트",
      cases: [
        { input: "맥도날드 빅맥세트 주문", expectedTag: "패스트푸드", expectedAccount: "651" },
        { input: "롯데리아 햄버거 배달", expectedTag: "패스트푸드", expectedAccount: "651" },
        { input: "버거킹 와퍼 주문", expectedTag: "패스트푸드", expectedAccount: "651" },
        { input: "KFC 치킨 구매", expectedTag: "패스트푸드", expectedAccount: "651" }
      ]
    },
    {
      name: "카페 테스트",
      cases: [
        { input: "스타벅스 아메리카노", expectedTag: "카페", expectedAccount: "651" },
        { input: "커피빈 라떼 주문", expectedTag: "카페", expectedAccount: "651" },
        { input: "이디야 커피 5000원", expectedTag: "카페", expectedAccount: "634" },
        { input: "투썸플레이스 케이크", expectedTag: "카페", expectedAccount: "651" }
      ]
    },
    {
      name: "온라인 서비스 테스트",
      cases: [
        { input: "쿠팡 생필품 주문", expectedTag: "온라인쇼핑", expectedAccount: "634" },
        { input: "배달의민족 치킨 배달", expectedTag: "배달앱", expectedAccount: "651" },
        { input: "요기요 피자 주문", expectedTag: "배달앱", expectedAccount: "651" },
        { input: "카카오택시 택시비", expectedTag: "교통", expectedAccount: "611" }
      ]
    }
  ]
};
...
function generateTagAccountMappingsSQL() {
  ...
  INITIAL_DATA.tagAccountMappings.forEach((mapping, index) => {
    const conditionJson = mapping.mappingCondition ? JSON.stringify(mapping.mappingCondition) : 'NULL';
    insertSQL.push(`
...
function saveTestCases() {
  ...
  fs.writeFileSync(testCasesPath, JSON.stringify(INITIAL_DATA.testCases, null, 2));
...
function main() {
  try {
    ...
    console.log(`- 키워드-태그 매핑: ${INITIAL_DATA.keywordTagMappings.length}개`);
    console.log(`- 태그-계정 매핑: ${INITIAL_DATA.tagAccountMappings.length}개`);
    console.log(`- 테스트 케이스: ${INITIAL_DATA.testCases.reduce((sum, suite) => sum + suite.cases.length, 0)}개`);
